---
title: "Troubleshooting: Invite Request Unhandled"
pagefind: false
sidebar:
  hidden: true
---

If you run into this issue, it means OyasumiVR was unable to handle an invite request you received on VRChat, due to OyasumiVR not knowing what world you are in.
OyasumiVR needs to know what world you are in to know what world to invite your friends to, and gets this information from your VRChat log files.
...
3. You can do this by pressing `Windows + R`, typing `C:\Users\%Username%\AppData\LocalLow\VRChat\vrchat` into the dialog box, and pressing `Enter`.
4. Find all log files that start with `output_log_` and delete them.
5. Start VRChat again
