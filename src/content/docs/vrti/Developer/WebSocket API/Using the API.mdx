...
By default, the websocket API is exposed on port `47126`. This port can be changed by the user within the settings dialog.
...
const socket = new WebSocket("ws://localhost:47126");
