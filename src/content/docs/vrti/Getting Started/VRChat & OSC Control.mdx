...
| :----------------------------------------------------- | :-------------------------------------------------------------- |
| ![The Menu](../../../../assets/vrti/vrc_menu_root.png) | ![Speed Sub Menu](../../../../assets/vrti/vrc_menu_control.png) |

| Autowalk Control                                           | Autowalk Speed Overrides                                         |
| :--------------------------------------------------------- | :--------------------------------------------------------------- |
| ![The Menu](../../../../assets/vrti/vrc_menu_autowalk.png) | ![Speed Sub Menu](../../../../assets/vrti/vrc_menu_override.png) |
